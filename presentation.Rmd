...
Alternate approach: define the MTD with respect to multiple toxicity contraints set on the separate grades:
...
Such that $t_l \le T \le t_{l+1}$ $iff$ $\gamma_l \le Z \le \gamma_{l+1}$ (Lee et al., 2011).
...
$$Pr(T \le t_{l+1}|x) - Pr(T \le t_{l} | x) = $$
